...
export class AddLyricComponent implements OnInit {
  ...
  setFeaturerName(featurerNameDisplay, featurerId, featurerName, feat){
    if (feat == 1) { this.featuring.one = featurerName; this.featurer.one = featurerId; this.featurerOneToAdd = null;}
    if (feat == 2) { this.featuring.two = featurerName; this.featurer.two = featurerId; this.featurerTwoToAdd = null;}
    if (feat == 3) { this.featuring.three = featurerName; this.featurer.three = featurerId; this.featurerThreeToAdd = null;}
    if (feat == 4) { this.featuring.four = featurerName; this.featurer.four = featurerId; this.featurerFourToAdd = null;}
    if (feat == 5) { this.featuring.five = featurerName; this.featurer.five = featurerId; this.featurerFiveToAdd = null;}
    if (feat == 6) { this.featuring.six = featurerName; this.featurer.six = featurerId; this.featurerSixToAdd = null;}
    if (feat == 7) { this.featuring.seven = featurerName; this.featurer.seven = featurerId; this.featurerSevenToAdd = null;}
